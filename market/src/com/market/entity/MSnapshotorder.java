...
public class MSnapshotorder implements java.io.Serializable {
	...
	/** minimal constructor */
	public MSnapshotorder(MGoods MGoods, MMember MMember, MOrder MOrder,
			Integer goodsNum, String createDate) {
		this.MGoods = MGoods;
	...
	/** full constructor */
	public MSnapshotorder(MGoods MGoods, MMember MMember,
			MGoodsformat MGoodsformat, MGoodsproperty MGoodsproperty,
			MOrder MOrder, Integer goodsNum, String createDate, String remark) {
		this.MGoods = MGoods;
		this.MMember = MMember;
