...
public class MProvince implements java.io.Serializable {
	...
	/** minimal constructor */
	public MProvince(Integer code, Integer parentId, String name, Integer level) {
		this.code = code;
	...
	/** full constructor */
	public MProvince(Integer code, Integer parentId, String name,
			Integer level, Set MAddressesForCountryId,
			Set MAddressesForProvinceId, Set MAddressesForAreaId,
			Set MAddressesForCityId) {
		this.code = code;
		this.parentId = parentId;
		this.name = name;
		this.level = level;
