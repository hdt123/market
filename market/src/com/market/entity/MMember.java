...
public class MMember implements java.io.Serializable {
	...
	/** minimal constructor */
	public MMember(String memberName, String password) {
		this.memberName = memberName;
		this.password = password;
	}

	/** full constructor */
	public MMember(String memberName, String password, String phoneNum,
			String email, Integer gender, String createTime,
			String lastLoginTime, Float totalPrice, Integer state,
			Set MShopcars, Set MCollectiongoodses, Set MSnapshotorders,
			Set MCollectionstores, Set MAddresses, Set MOrders, Set MRejecteds) {
		this.memberName = memberName;
		this.password = password;
